...
void util_WritePrefs(uint8_t *, const uint8_t, const bool, const bool, const uint8_t, const bool, const bool, const bool, const bool, const bool, const bool, const unsigned int, const unsigned int);
